...
public class DsParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ds");
  ...
  { 
    DsParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = DsParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = DsParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(DsParseControllerGenerated.class);
    }
  ...
  { 
    return DsParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
